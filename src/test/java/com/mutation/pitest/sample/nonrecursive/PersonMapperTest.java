...
public class PersonMapperTest {
	...
	public void shouldReturnVLocLegalEntityWhenGivenLegalEntityBusinessDtoNape() {
		...
		assertThat(personDto.getFirstName()).isNotNull().isEqualTo(expectedPerson.getFirstName());
		assertThat(personDto.getLastName()).isNotNull().isEqualTo(expectedPerson.getLastName());
		assertThat(personDto.getAge()).isNotNull().isEqualTo(expectedPerson.getAge());
		assertThat(personDto.getAddress().getCity()).isNotNull().isEqualTo(expectedPerson.getAddress().getCity());
		assertThat(personDto.getAddress().getCountry()).isNotNull().isEqualTo(expectedPerson.getAddress().getCountry());
		assertThat(personDto.getAddress().getNumber()).isNotNull().isEqualTo(expectedPerson.getAddress().getNumber());
		assertThat(personDto.getAddress().getStreet()).isNotNull().isEqualTo(expectedPerson.getAddress().getStreet());
